		...
		return BaseController.extend("au.com.bournedigital.developertest.controller.Worklist", {
			...
			onSearch : function (oEvent) {
				if (oEvent.getParameters().refreshButtonPressed) {
					...
					if (sQuery && sQuery.length > 0) {
						aTableSearchState = [new Filter([new Filter("CustomerID", FilterOperator.Contains, sQuery),
                                            ...
                                            new Filter("Employee/LastName", FilterOperator.Contains, sQuery)], false)];
					}
			...
			_showObject : function (oItem) {
				this.getRouter().navTo("object",{
                    objectId: oItem.getBindingContext().getObject("OrderID")
                });
			},
